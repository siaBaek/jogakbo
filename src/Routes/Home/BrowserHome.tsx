  ...
  return (
    <>
      ...
      <BrowserContainer>
        ...
        <Section>
          <Title>✔️ Q&A</Title>
          <Question onClick={() => onClickQuestion(1)}>
            ❔ 기부한 금액의 사용처는 어떻게 알 수 있나요?
          </Question>
          <Answer id="1">
            ❗️ 캠페인 생성과 동시에 블록체인에 등록되어 모든 거래가 기록됩니다
          </Answer>
          <Question onClick={() => onClickQuestion(2)}>
            ❔ 캠페인 기부 조건을 달성하지 못할 시 환불절차는 어떻게 되나요?
          </Question>
          <Answer id="2">
            ❗️ 조건 금액을 달성하지 못한 캠페인은 환불 상태로 변경되며 기간 내
            환불 요청이 가능해지게 됩니다
          </Answer>
          <Question onClick={() => onClickQuestion(3)}>
            ❔ 캠페인은 아무나 생성할 수 있나요?
          </Question>
          <Answer id="3">
